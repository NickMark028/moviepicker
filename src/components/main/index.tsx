    ...
    render() {
        return (
            <>
                ...
                <>
                    <section
                        className="w3l-main-slider position-relative"
                        id="home"
                    >
                                    ...
                                    <li>
                                        <div className="slider-info banner-view bg bg2">
                                            <div className="banner-info">
                                                ...
                                                <a
                                                    href="#small-dialog1"
                                                    className="popup-with-zoom-anim play-view1"
                                                >
                                        ...
                                        <div className="box16">
                                            <a href="movie">
                                                <figure>
                                                    <img
                                                        className="img-fluid"
                                                        src="assets/images/wednesday.jpeg"
                                                    />
                                                </figure>
                                        ...
                                        <div className="box16">
                                            <a href="movie">
                                                <figure>
                                                    <img
                                                        className="img-fluid"
                                                        src="assets/images/commando2.jpeg"
                                                    />
                                                </figure>
                                                <div className="box-content">
                                                    <h3 className="title">
                                        ...
                                        <div className="box16">
                                            <a href="movie">
                                                <figure>
                                                    <img
                                                        className="img-fluid"
                                                        src="assets/images/avtar-2.jpeg"
                                                    />
                                                </figure>
                                                <div className="box-content">
                                                    <h3 className="title">
                ...
                <script src="assets/js/easyResponsiveTabs.js" />
